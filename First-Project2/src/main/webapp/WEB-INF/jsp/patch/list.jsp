...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function ($) {
            ...
            $("#jqGrid").jqGrid({
                url: "http://localhost:8080/patch/getlist",
                datatype: 'json',
                mtype: 'GET',
                colNames: ['ID', '고객사', '제품', '패치제목', '패치날짜', '등록자'],
                colModel: [
                    {name: "patchId", label: "patchId", width: 20, key: true, hidden: false},
                    {name: "customerName", label: "customerName", width: 60, editable: false},
                    {name: "productName", label: "productName", width: 90, editable: false},
                    {name: "patchTitle", label: "patchTitle", width: 200, editable: true},
                    {name: "patchDate", label: "patchDate", width: 80, editable: true},
                    {name: "patchRegistrant", label: "patchRegistrant", width: 50, editable: true},
                ],
                pager: '#pager',
                loadonce: true,
                rowNum: 15,
                ...
                <div class="row">
                    ...
                    <div>
                        <button class="btn btn-outline-primary " style="float: right;"
                                onclick="location.href='http://localhost:8080/patch/enroll'">추가
                        </button>
                    </div>
                </div>
            </div>
