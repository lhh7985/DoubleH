...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function ($) {
            $("#jqGrid").jqGrid({
                url: "http://localhost:8080/product/getlist",
                datatype: 'json',
                mtype: 'GET',
                colNames: ['', '사업건 번호', '고객사', '제품', '수량', '납품일', ''],
                colModel: [
                    {name: "deliveryId", label: "deliveryId", key: true, width: 50, hidden: true},
                    {name: "deliveryBusinessNum", label: "deliveryBusinessNum", width: 50, hidden: false},
                    {name: "customerName", label: "customerName", width: 100, hidden: false},
                    {name: "productName", label: "productName", width: 200, editable: true},
                    {name: "deliveryQuantity", label: "deliveryQuantity", width: 80, editable: true},
                    {name: "deliveryDate", label: "deliveryDate", width: 80, editable: true},
                ...
                onCellSelect: function (rowid) {
                    ...
                    if (rowid.productName == "iGRIFFIN" || rowid.productName == "ToS") {
                        $.ajax({
                            type: 'GET',
                            url: '/customer/' + rowid.deliveryId + '/os',
            ...
            }).navGrid('#pager', {edit: false, add: false, del: true, search: false, refresh: true},
                {
                    url: '#',
                    closeOnExcqpe: true,
                    recreateForm: true,
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="row">
                    <div class="col-md-11">
                        <h6 class="mb-0 font-weight-bold text-primary">납품정보</h6>
                    </div>
                    <div>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="mb-0 font-weight-bold text-primary">OS</h6>
            </div>
            <div class="card-body">
                <div class="" style="">
                    <div id="os"></div>
